...
export const DATA: SiteData = {
  ...
  work: {
    ...
    filters: [
      ...
      { id: 'commerce', en: 'E-commerce', es: 'Comercio' },
    ],
    items: [
      { ind: 'commerce', dark: true, year: '2026', en_t: 'Holoverse TCG', es_t: 'Holoverse TCG',
        en: 'A trading-card marketplace for Magic, Pokémon and One Piece: graded singles, sealed chests and weekly drops, with a peer-to-peer trading system, social features for collectors, and a complete store-administration suite for inventory, orders and fulfillment.',
        es: 'Un marketplace de cartas coleccionables de Magic, Pokémon y One Piece: singles calificados, cofres sellados y drops semanales, con sistema de intercambio peer-to-peer, elementos sociales para coleccionistas y un esquema completo de administración de tienda para inventario, pedidos y despacho.',
        img: '/projects/holoverse.png',
        alt: { en: 'Holoverse TCG storefront homepage showing featured trading cards and a "Las joyas viven en el Holoverse" hero', es: 'Página principal de la tienda Holoverse TCG con cartas destacadas y el hero "Las joyas viven en el Holoverse"' },
        url: 'https://www.holoversetcg.store' },
  ...
  form: {
    tag: { en: 'Start a project', es: 'Empecemos' },
    h2: { en: "Tell us what you're building", es: 'Cuéntanos qué quieres construir' },
    p: { en: "A few details about your project and we'll take it from there.", es: 'Unos detalles sobre tu proyecto y nosotros nos encargamos del resto.' },
    ...
    messagePh: { en: 'What are you building, and what problem does it solve?', es: '¿Qué quieres construir y qué problema resuelve?' },
